...
export class Tetris extends Game {
    ...
    public override players = [
        new Player(
            ...
            { 'move0': 0, 'start0': 0 },
            {
                a: { variableName: 'move0', pressedValue: 1, releasedValue: 0 },
                d: { variableName: 'move0', pressedValue: 2, releasedValue: 0 },
                w: { variableName: 'move0', pressedValue: 3, releasedValue: 0 },
                s: { variableName: 'move0', pressedValue: 4, releasedValue: 0 },
                ' ': { variableName: 'start0', pressedValue: 1, releasedValue: 0 },
            },
        ...
        new Player(
            ...
            { 'move1': 0, 'start1': 0 },
            {
                ArrowLeft: { variableName: 'move1', pressedValue: 1, releasedValue: 0 },
                ArrowRight: { variableName: 'move1', pressedValue: 2, releasedValue: 0 },
                ArrowUp: { variableName: 'move1', pressedValue: 3, releasedValue: 0 },
                ArrowDown: { variableName: 'move1', pressedValue: 4, releasedValue: 0 },
                Enter: { variableName: 'start1', pressedValue: 1, releasedValue: 0 },
            },
